#given the input of a student number, generat two integers indicating the question that a studen needs to answer.
...
#Use a simple algorithm to generate two distict numbers from 1 to num_questions
...
try:
    ...
    print(f"Your tow assignments are {num1} and {num2}")
