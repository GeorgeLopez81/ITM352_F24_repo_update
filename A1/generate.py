#given the input of a student number, generat two integers indicating the 
# question that a studen needs to answer.

# Given the input of a student number, generate two integers indicating the 
