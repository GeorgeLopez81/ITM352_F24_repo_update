#1.	Read in a CSV file with sales data, called sales_data.csv, and print the first 5 rows.
#Creat a pivot table , aggregating sales by region, with columns defined by order_type (which is either
# Tetail or Wholesale) Add in sub-columns showing the average sales by state, by sale type
#(retail or sholesale.)
...
#Print the first 5 rows and pivot table
