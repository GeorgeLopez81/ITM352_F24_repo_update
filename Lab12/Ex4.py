##xtract Json data form data.cityofChicago.org on vehicles and their fuel sources
import pandas as pd
...
results = client.get("rr23-ymwb", limit=500) #look up "rr23-ymwb"
...
# Group by fuel source and count the occurrences
